...
int ssv6xxx_sdio_slow_clock = 0;
module_param(ssv6xxx_sdio_slow_clock, int, 0644);
MODULE_PARM_DESC(ssv6xxx_sdio_slow_clock, "Keep SDIO bus at 25MHz after firmware load (1) instead of raising to 50MHz (0). Required on Amlogic Meson boxes (SSV6X5X) to avoid EILSEQ errors");
