...
static void ssv6xxx_dump_sta_info (struct ssv_softc *sc)
{
    int j, sta_idx = 0;
    struct ssv_cmd_data *cmd_data = &sc->cmd_data;
...
#endif
static void print_isr_info(struct ssv_cmd_data *cmd_data, struct ssv6xxx_hci_ctrl *hci_ctrl)
{
...
static int txtput_generate_m2(struct ssv_softc *sc, u32 size_per_frame, u32 loop_times)
{
